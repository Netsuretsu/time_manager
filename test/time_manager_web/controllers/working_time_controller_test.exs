defmodule TimeManagerWeb.Working_timeControllerTest do
  ...
  @update_attrs %{
    start: ~N[2023-10-24 13:34:00],
    end: ~N[2023-10-24 13:34:00]
  }
  ...
  describe "create working_time" do
    test "renders working_time when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2023-10-23T13:34:00",
               "start" => "2023-10-23T13:34:00"
  ...
  describe "update working_time" do
    ...
    test "renders working_time when data is valid", %{conn: conn, working_time: %Working_time{id: id} = working_time} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2023-10-24T13:34:00",
               "start" => "2023-10-24T13:34:00"
             } = json_response(conn, 200)["data"]
    end
